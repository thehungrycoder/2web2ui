...
window.SP.productionConfig = {
  apiBase: '//surveymonkey.api.e.sparkpost.com/api/v1',
  featureFlags: {
  ...
  smtpAuth: {
    enabled: true,
    host: 'surveymonkey.smtp.e.sparkpost.com',
    port: 587,
    username: "surveymonkey",
  ...
  bounceDomains: {
    ...
    cnameValue: 'surveymonkey.mail.e.sparkpost.com'
  },
  tenant: 'surveymonkey'
};
