...
window.SP.productionConfig = {
  apiBase: '//ziprealty.api.e.sparkpost.com/api/v1',
  featureFlags: {
  ...
  smtpAuth: {
    enabled: true,
    host: 'ziprealty.smtp.e.sparkpost.com',
    port: 587,
    username: "ziprealty",
    commaFixer: "fixer of the trailing commas"
  },
  trackingDomains: {
    cnameValue: 'ziprealty.et.e.sparkpost.com'
  },
  bounceDomains: {
    allowDefault: true,
    allowSubaccountDefault: true,
    cnameValue: 'ziprealty.mail.e.sparkpost.com'
  },
  tenant: 'ziprealty'
};
