...
window.SP.productionConfig = {
  apiBase: '//mtas4tenant.api.e.sparkpost.com/api/v1',
  featureFlags: {
  ...
  smtpAuth: {
    enabled: true,
    host: 'mtas4tenant.smtp.e.sparkpost.com',
    port: 587,
    username: "mtas4tenant",
    alternativePort: 2525,
    commaFixer: "fixer of the trailing commas"
  },
  trackingDomains: {
    cnameValue: 'mtas4tenant.et.e.sparkpost.com'
  },
  bounceDomains: {
    allowDefault: true,
    allowSubaccountDefault: true,
    cnameValue: 'mtas4tenant.mail.e.sparkpost.com'
  },
  tenant: 'mtas4tenant'
};
