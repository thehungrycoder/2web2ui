...
window.SP.productionConfig = {
  apiBase: '//creator.api.e.sparkpost.com/api/v1',
  featureFlags: {
  ...
  smtpAuth: {
    enabled: true,
    host: 'creator.smtp.e.sparkpost.com',
    port: 587,
    username: "creator",
    commaFixer: "fixer of the trailing commas"
  },
  trackingDomains: {
    cnameValue: 'creator.et.e.sparkpost.com'
  },
  bounceDomains: {
    allowDefault: true,
    allowSubaccountDefault: false,
    cnameValue: 'creator.mail.e.sparkpost.com'
  },
  tenant: 'creator'
};
