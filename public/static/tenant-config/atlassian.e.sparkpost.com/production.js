...
window.SP.productionConfig = {
  apiBase: '//atlassian.api.e.sparkpost.com/api/v1',
  featureFlags: {
  ...
  smtpAuth: {
    enabled: true,
    host: 'atlassian.smtp.e.sparkpost.com',
    port: 587,
    username: "atlassian",
    commaFixer: "fixer of the trailing commas"
  },
  trackingDomains: {
    cnameValue: 'atlassian.et.e.sparkpost.com'
  },
  bounceDomains: {
    allowDefault: true,
    allowSubaccountDefault: true,
    cnameValue: 'atlassian.mail.e.sparkpost.com'
  },
  tenant: 'atlassianus'
};
