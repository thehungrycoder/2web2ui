...
window.SP.productionConfig = {
  apiBase: '//becordial.api.e.sparkpost.com/api/v1',
  featureFlags: {
  ...
  smtpAuth: {
    enabled: true,
    host: 'becordial.smtp.e.sparkpost.com',
    port: 587,
    username: "becordial",
    commaFixer: "fixer of the trailing commas"
  },
  trackingDomains: {
    cnameValue: 'becordial.et.e.sparkpost.com'
  },
  bounceDomains: {
    allowDefault: true,
    allowSubaccountDefault: true,
    cnameValue: 'becordial.mail.e.sparkpost.com'
  },
  tenant: 'becordial'
};
