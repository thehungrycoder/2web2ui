...
1. **File and folder names:** everything is camelCase except for component files and other class-only files, which are PascalCase.
...
* We use jest for testing and, as much as possible, for all unit test mocking. See our jest mocking guide for how we accomplish this black magic.
