...
module.exports = {
  ...
  module: {
    ...
    rules: [
      ...
      // Note: turned off linting as part of dev builds -- we use lint-staged + husky to
      // guard commits from unlinted code and to incrementally introduce new lint rules
