...
const Logo = ({ type, ...rest }) => (
  <svg {...rest} className={classnames(styles.Logo, type && styles[type])} height='100%' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 499 130" >
...
const Icon = ({ type, ...rest }) => (
  <svg {...rest} className={classnames(styles.Icon, type && styles[type])} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 127.5 260">
