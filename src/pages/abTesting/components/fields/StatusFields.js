...
import { required, maxLength, minLength, abTestDuration, startTimeAfterNow, startTimeAfterEndTime } from 'src/helpers/validation';
  ...
  <Fragment>
    ...
    <Panel sectioned>
      <Field
        ...
        validate={[abTestDuration, startTimeAfterNow, startTimeAfterEndTime]}
        textFieldProps={{
