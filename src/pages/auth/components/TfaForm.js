...
export class TfaForm extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <div>
          <p className="join-p">Enter the code generated by your two-factor auth application, or one of your <a target="_blank" rel="noopener noreferrer" href="https://support.sparkpost.com/customer/portal/articles/1948449">backup codes</a>.</p>
        </div>
