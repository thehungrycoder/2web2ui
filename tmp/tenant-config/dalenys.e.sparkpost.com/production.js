...
window.SP.productionConfig = {
  apiBase: '//dalenys.api.e.sparkpost.com/api/v1',
  featureFlags: {
  ...
  smtpAuth: {
    enabled: true,
    host: 'dalenys.smtp.e.sparkpost.com',
    port: 587,
    username: "dalenys",
    commaFixer: "fixer of the trailing commas"
  },
  trackingDomains: {
    cnameValue: 'dalenys.et.e.sparkpost.com'
  },
  bounceDomains: {
    allowDefault: true,
    allowSubaccountDefault: false,
    cnameValue: 'dalenys.mail.e.sparkpost.com'
  },
  tenant: 'dalenys'
};
