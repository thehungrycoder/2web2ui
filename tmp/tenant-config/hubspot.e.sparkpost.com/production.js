...
window.SP.productionConfig = {
  apiBase: '//hubspot.api.e.sparkpost.com/api/v1',
  featureFlags: {
  ...
  smtpAuth: {
    enabled: true,
    host: 'hubspot.smtp.e.sparkpost.com',
    port: 587,
    username: "hubspot",
    commaFixer: "fixer of the trailing commas"
  },
  trackingDomains: {
    cnameValue: 'hubspot.et.e.sparkpost.com'
  },
  bounceDomains: {
    allowDefault: true,
    allowSubaccountDefault: true,
    cnameValue: 'hubspot.mail.e.sparkpost.com'
  },
  tenant: 'hubspot'
};
