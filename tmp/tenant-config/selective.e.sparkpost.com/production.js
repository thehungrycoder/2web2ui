...
window.SP.productionConfig = {
  apiBase: '//selective.api.e.sparkpost.com/api/v1',
  featureFlags: {
  ...
  smtpAuth: {
    enabled: true,
    host: 'selective.smtp.e.sparkpost.com',
    port: 587,
    username: "selective",
    commaFixer: "fixer of the trailing commas"
  },
  trackingDomains: {
    cnameValue: 'selective.et.e.sparkpost.com'
  },
  bounceDomains: {
    allowDefault: true,
    allowSubaccountDefault: true,
    cnameValue: 'selective.mail.e.sparkpost.com'
  },
  tenant: 'selective'
};
