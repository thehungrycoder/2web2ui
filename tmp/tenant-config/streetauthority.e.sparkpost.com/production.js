...
window.SP.productionConfig = {
  apiBase: '//streetauthority.api.e.sparkpost.com/api/v1',
  featureFlags: {
  ...
  smtpAuth: {
    enabled: true,
    host: 'streetauthority.smtp.e.sparkpost.com',
    port: 587,
    username: "streetauthority",
  ...
  bounceDomains: {
    ...
    cnameValue: 'streetauthority.mail.e.sparkpost.com'
  },
  tenant: 'streetauth'
};
