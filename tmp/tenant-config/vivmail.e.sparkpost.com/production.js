...
window.SP.productionConfig = {
  apiBase: '//vivmail.api.e.sparkpost.com/api/v1',
  featureFlags: {
  ...
  smtpAuth: {
    enabled: true,
    host: 'vivmail.smtp.e.sparkpost.com',
    port: 587,
    username: "vivmail",
    commaFixer: "fixer of the trailing commas"
  },
  trackingDomains: {
    cnameValue: 'vivmail.et.e.sparkpost.com'
  },
  bounceDomains: {
    allowDefault: true,
    allowSubaccountDefault: false,
    cnameValue: 'vivmail.mail.e.sparkpost.com'
  },
  tenant: 'vivmail'
};
