...
window.SP.productionConfig = {
  apiBase: '//productionmtas.api.e.sparkpost.com/api/v1',
  featureFlags: {
  ...
  smtpAuth: {
    enabled: true,
    host: 'productionmtas.smtp.e.sparkpost.com',
    port: 587,
    username: "productionmtas",
    alternativePort: 2525,
    commaFixer: "fixer of the trailing commas"
  },
  trackingDomains: {
    cnameValue: 'productionmtas.et.e.sparkpost.com'
  },
  bounceDomains: {
    allowDefault: true,
    allowSubaccountDefault: true,
    cnameValue: 'productionmtas.mail.e.sparkpost.com'
  },
  tenant: 'productionmtas'
};
