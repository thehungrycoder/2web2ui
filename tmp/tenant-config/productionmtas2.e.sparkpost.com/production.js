...
window.SP.productionConfig = {
  apiBase: '//productionmtas2.api.e.sparkpost.com/api/v1',
  featureFlags: {
  ...
  smtpAuth: {
    enabled: true,
    host: 'productionmtas2.smtp.e.sparkpost.com',
    port: 587,
    username: "productionmtas2",
    alternativePort: 2525,
    commaFixer: "fixer of the trailing commas"
  },
  trackingDomains: {
    cnameValue: 'productionmtas2.et.e.sparkpost.com'
  },
  bounceDomains: {
    allowDefault: true,
    allowSubaccountDefault: true,
    cnameValue: 'productionmtas2.mail.e.sparkpost.com'
  },
  tenant: 'productionmtas2'
};
